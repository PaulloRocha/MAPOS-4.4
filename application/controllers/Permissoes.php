    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = [
                ...
                'aMensalidade' => $this->input->post('aMensalidade'),
                'eMensalidade' => $this->input->post('eMensalidade'),
                'dMensalidade' => $this->input->post('dMensalidade'),
                'vMensalidade' => $this->input->post('vMensalidade'),
                ...
                'rMensalidade' => $this->input->post('rMensalidade'),
