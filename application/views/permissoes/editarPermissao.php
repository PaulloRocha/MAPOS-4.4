...
<div class="span12" style="margin-left: 0">
    ...
    if ($permissoes['dProduto'] == '1') {
        echo 'checked';
                                ...
                                <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vMensalidade'])) {
                                                if ($permissoes['vMensalidade'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="vMensalidade" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Mensalidade</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aMensalidade'])) {
                                                if ($permissoes['aMensalidade'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="aMensalidade" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Mensalidade</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['eMensalidade'])) {
                                                if ($permissoes['eMensalidade'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="eMensalidade" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Mensalidade</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dMensalidade'])) {
                                                if ($permissoes['dMensalidade'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="dMensalidade" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Mensalidade</span>
                                        </label>
                                    </td>
