                        ...
                        <div class="controls">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vMensalidade" class="marcar" type="checkbox" checked="checked" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="aMensalidade" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="eMensalidade" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="dMensalidade" class="marcar" type="checkbox" value="1" />
