...
<div class="container-fluid">
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vMensalidade')) : ?>
                <li class="bg_ly">
                    <a href="<?= base_url() ?>index.php/mensalidades"> <i class="fas fa-money-bill-alt" style="font-size:36px"></i>
                        <div>Mensalidades <span class="badge badge-light">F8</span></div>
                    </a>
                </li>
            <?php endif ?>
